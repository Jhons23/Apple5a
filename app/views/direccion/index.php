...
<div class="container">
    ...
    <a href="/apple5a/public/direccion/create"><button>Agregar</button></a>
            ...
            <?php if (!empty($direccions) && is_array($direccions)): ?>
                <?php foreach ($direccions as $direccion): ?>
                    <tr>
                        ...
                        <td>
    <a href="/apple5a/public/direccion/edit?iddireccion=<?php echo htmlspecialchars($direccion['iddireccion']); ?>">
        <button>Editar</button>
    </a>
    <a href="/apple5a/public/direccion/eliminar?iddireccion=<?php echo htmlspecialchars($direccion['iddireccion']); ?>" 
